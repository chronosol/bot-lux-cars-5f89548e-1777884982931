...
// in business_chatbot_template/test/core/websocket/websocket_service_test.dart.
...
import 'package:socket_io_common/src/util/event_emitter.dart' as _i5;
...
class MockSocket extends _i1.Mock implements _i3.Socket {
  ...
  @override
  set json(_i3.Socket? value) => super.noSuchMethod(
        Invocation.setter(
          #json,
          value,
        ),
  ...
  void on(
    String? event,
    _i5.EventHandler<dynamic>? handler,
  ) =>
      super.noSuchMethod(
        Invocation.method(
          #on,
  ...
  @override
  void onAny(_i5.AnyEventHandler<dynamic>? handler) => super.noSuchMethod(
        Invocation.method(
          #onAny,
          [handler],
        ),
  ...
  @override
  void offAny([_i5.AnyEventHandler<dynamic>? handler]) => super.noSuchMethod(
        Invocation.method(
          #offAny,
          [handler],
        ),
